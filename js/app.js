...
(function(){
	...
	//Application module
	compentencyProfile.controller("CompetencyController", ['$http', '$scope', '$filter', '$window', function ($http, $scope, $filter, $window) {
	...
	compentencyProfile.directive("competencyTable", function (){
		return {
			restrict: 'E',
